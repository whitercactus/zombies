...
class Game:
    ...
    def load_data(self):
        self.map_dir = path.dirname(__file__)
        ...
        self.mob_splat = pg.image.load(MOB_SPLAT).convert_alpha()
        ...
        self.weapon_sounds = {}
        self.grass_tile = pg.image.load(GRASS_IMG).convert_alpha()
        ...
        s = pg.mixer.Sound("zombie-roar1.wav")
        s.set_volume(0.4)
        self.zombie_moan_sounds.append(s)
        self.zombie_atack_sound = pg.mixer.Sound(ZOMBIE_HIT_SOUND)
